        ...
        try {
            ...
            if (count($this->attendance_data) > 0) {
                ...
                while (strlen($attendance_data) > 40) {
                    ...
                    $state = hexdec(substr($u[1], 66, 2)); // TO CHANGE THE STATE/STATUS FOR LOOKING CHECK_IN AND CHECNK_OUT(66)
                    // BUT IF U WANT TO CHANGE AND FIND TABLE "ARAH" U CAN CHANGE TO 56 ABOVE 
