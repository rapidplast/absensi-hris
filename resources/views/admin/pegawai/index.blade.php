                                ...
                                <tbody>
                                    ...
                                    @foreach ($pegawai as $data)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (Auth()->user()->role->id == 1)
                                                    <a href="{{ route('editPegawai', $data->id) }}"
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-interval="0" data-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <p>Pastikan mesin "ON" secara default sesuai dengan data pegawai yang ingin ditarik. Berikut
                            ...
                            <div class="carousel-item">
                                <p>Setelah menyalakan mesin "ON", kembali ke halaman Data Pegawai, lalu klik button "sync
                                    pegawai". Tunggu beberapa saat, jika berhasil terdapat pop up berhasil dan halaman akan
                                    reload.</p>
