@extends('layouts.index', ['title' => 'Master Divisi'])
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-header">
                    ...
                    <a href="{{route('addDivisi')}}" class="text-decoration-none">
                ...
                <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->nama }}</td>
                            <td>
                                <a href="{{ route('editDivisi', $data->id) }}" class="btn btn-sm btn-warning">Ubah</a>
    ...
    function destroy(id){
        ...
        .then((willDelete) => {
            if(willDelete) {
                ...
                $.ajax({
                        url: "{{url('Admin/Divisi/Delete')}}/"+id,
                        method: 'DELETE',
                ...
                swal("Data Divisi Batal Dihapus", "", "info")
            }
        })
    }
</script>
