                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if (Auth()->user()->role->id == 1)
                                @if (Route::is('searchAbsensi'))
                                    <a
                                        href="{{ route('cetakSearch.TXT', ['tanggal' => $tanggal, 'tanggal2' => $tanggal2, 'dbName' => $dbName]) }}">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($absensi as $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if (Auth()->user()->role->id == 1)
                                                    <a href="{{ route('editAbsensi', ['id' => $data->id, 'pid' => $data->pid, 'date' => date('Y-m-d', strtotime($data->sync_date))]) }}"
                                                        class="btn btn-sm btn-warning">Ubah</a>
                                                    <button class="btn btn-sm btn-danger" id="btn-delete"
                                                        onclick="destroy('{{ $data->id }}')">Hapus</button>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-interval="0" data-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <p>Pastikan mesin "ON" secara default sesuai dengan data absensi yang ingin ditarik. Berikut
                                    tutorial cara cek apakah mesin "ON".</p>
                                <img src="{{ asset('public/tutorial/TarikPegawai1.gif') }}" class="d-block w-100">
                            </div>
                            <div class="carousel-item">
                                <p>Jika tidak ada mesin "ON", klik button "OFF" pada kolom default. Ketika muncul pop up
                                    dengan text "Anda Yakin? Untuk Default Mesin Ini?", Klik "OK".</p>
                                <img src="{{ asset('public/tutorial/TarikPegawai2.gif') }}" class="d-block w-100">
                            </div>
                            <div class="carousel-item">
                                <p>Setelah menyalakan mesin "ON", kembali ke halaman Data Absensi, lalu klik button "Tarik
                                    Absen". Tunggu beberapa saat, jika berhasil terdapat pop up berhasil dan halaman akan
                                    reload.</p>
