...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link text-decoration-none">
        <img src="{{ asset('public/backend/file/images/rapidplast.ico') }}" alt="AdminLTE Logo"
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
             ...
             with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <a href="{{ route('pegawaii') }}"
                        class="nav-link {{ request()->is('/pegawai') || request()->is('/pegawai/*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    @if (Auth()->user()->role->id == 1)
                        {{-- <a href="{{route('absensi')}}" class="nav-link {{request()->is('Admin/Absensi') || request()->is('Admin/Absensi/*')  ? 'active' : ''}}"> --}}
                        <a href="{{ route('pay') }}"
                            class="nav-link {{ request()->is('pay') || request()->is('pay/*') ? 'active' : '' }}">
                ...
                @if (Auth()->user()->role->id == 1)
                    <li class="nav-item">
                        <a href="{{ route('absensilog') }}"
                            class="nav-link {{ request()->is('Admin/Absensi-Log') || request()->is('Admin/Absensi-Log/*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    @if (Auth()->user()->role->id == 1)
                        <a href="{{ route('mesin') }}"
                            class="nav-link {{ request()->is('Admin/Mesin') || request()->is('Admin/Mesin/*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('departement') }}"
                        class="nav-link {{ request()->is('Admin/Departement') || request()->is('Admin/Departement/*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('divisi') }}"
                        class="nav-link {{ request()->is('Admin/Divisi') || request()->is('Admin/Divisi/*') ? 'active' : '' }}">
          ...
          <a href="{{ route('alasan') }}" class="nav-link {{ request()->is('Admin/Alasan') || request()->is('Admin/Alasan/*') ? 'active' : '' }}">
            ...
            <p>
              Alasan
                ...
                <li class="nav-item">
                    <a href="{{ route('referensiKerja') }}"
                        class="nav-link {{ request()->is('Admin/Referensi-Kerja') || request()->is('Admin/Referensi-Kerja/*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('reguKerja') }}"
                        class="nav-link {{ request()->is('Admin/Regu-Kerja') || request()->is('Admin/Regu-Kerja/*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('hariLibur') }}"
                        class="nav-link {{ request()->is('Admin/Hari-Libur') || request()->is('Admin/Hari-Libur/*') ? 'active' : '' }}">
              ...
              Absensi WFH
                ...
                <li class="nav-item">
                    <a href="{{ route('laporanAbsensi') }}"
                        class="nav-link {{ request()->is('Admin/Laporan-Absensi') || request()->is('Admin/Absensi-Work-From-Home/*') ? 'active' : '' }}">
